...
{
	public abstract class AbstractExtronSwitcherDeviceSettings : AbstractDeviceSettings, IExtronSwitcherDeviceSettings
	{
		...
		/// Constructor.
		/// </summary>
		protected AbstractExtronSwitcherDeviceSettings()
		{

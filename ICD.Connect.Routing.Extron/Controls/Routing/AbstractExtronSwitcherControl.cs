...
{
	public abstract class AbstractExtronSwitcherControl<TSwitcher> : AbstractRouteSwitcherControl<TSwitcher>, IExtronSwitcherControl
		where TSwitcher : IExtronSwitcherDevice
	{
		...
		protected AbstractExtronSwitcherControl(TSwitcher parent, int id, int numInputs, int numOutputs, bool breakaway)
			: base(parent, id)
		{
		...
		protected override void Subscribe(TSwitcher parent)
		{
		...
		protected override void Unsubscribe(TSwitcher parent)
		{

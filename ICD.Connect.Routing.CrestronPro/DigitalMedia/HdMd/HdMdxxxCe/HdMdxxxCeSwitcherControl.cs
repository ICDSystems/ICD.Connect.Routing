...
namespace ICD.Connect.Routing.CrestronPro.DigitalMedia.HdMd.HdMdxxxCe
{
	public sealed class HdMdxxxCeSwitcherControl : AbstractRouteSwitcherControl<IHdMdxxxCeAdapter>
	{
		...
		[CanBeNull] private HdMdxxxCE m_Switcher;

		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="parent"></param>
		public HdMdxxxCeSwitcherControl(IHdMdxxxCeAdapter parent)
			: base(parent, 0)
		{
...
// ReSharper disable once NotResolvedInText
		...
		/// </summary>
		/// <param name="parent"></param>
		protected override void Subscribe(IHdMdxxxCeAdapter parent)
		{
		...
		/// </summary>
		/// <param name="parent"></param>
		protected override void Unsubscribe(IHdMdxxxCeAdapter parent)
		{
		...
		{
			SetSwitcher(crestronSwitchAdapter.Switcher as HdMdxxxCE);
		}
		...
		private void SetSwitcher(HdMdxxxCE switcher)
		{
		...
		/// </summary>
		/// <param name="switcher"></param>
		private void Subscribe(HdMdxxxCE switcher)
		{
			if (switcher == null)
				return;
		...
		/// </summary>
		/// <param name="switcher"></param>
		private void Unsubscribe(HdMdxxxCE switcher)
		{
			if (switcher == null)
				return;

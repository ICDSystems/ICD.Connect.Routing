...
// ReSharper disable once NotResolvedInText
		...
		private bool GetSignalDetectedFeedback(int input, eConnectionType type)
		{
			...
			{
				case eConnectionType.Video:
					return switcherInput.VideoDetectedFeedback.GetBoolValueOrDefault();
		...
		/// </summary>
		/// <param name="parent"></param>
		protected override void Subscribe(IDmMd6XNAdapter parent)
		{
		...
		/// </summary>
		/// <param name="parent"></param>
		protected override void Unsubscribe(IDmMd6XNAdapter parent)
		{

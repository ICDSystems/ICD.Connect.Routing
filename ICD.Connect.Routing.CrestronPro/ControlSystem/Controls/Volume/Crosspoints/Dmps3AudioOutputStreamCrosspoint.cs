...
{
	public sealed class Dmps3AudioOutputStreamCrosspoint : AbstractDmps3Crosspoint
	{
		private readonly Card.Dmps3HdmiAudioOutput.Dmps3AudioOutputStream m_Output;
		...
		public Dmps3AudioOutputStreamCrosspoint(ControlSystemDevice parent,
		                                        [NotNull] Card.Dmps3HdmiAudioOutput.Dmps3AudioOutputStream output ,eDmps3InputType inputType, uint inputAddress) : base(parent, inputType, inputAddress)
		{
			if (output == null)

...
namespace ICD.Connect.Routing.CrestronPro.ControlSystem
{
	public interface IControlSystemExternalTelemetryProvider : IExternalTelemetryProvider
	{
		...
		[DynamicPropertyTelemetry(DeviceTelemetryNames.DEVICE_UPTIME, DeviceTelemetryNames.DEVICE_UPTIME_CHANGED)]
		...
		[DynamicPropertyTelemetry(DeviceTelemetryNames.DEVICE_HOSTNAME_SECONDARY, DeviceTelemetryNames.DEVICE_HOSTNAME_SECONDARY_CHANGED)]

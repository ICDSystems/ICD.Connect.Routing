...
{
#if SIMPLSHARP
	public sealed class DmRmc100CAdapter : AbstractDmRmc100CBaseAdapter<Crestron.SimplSharpPro.DM.Endpoints.Receivers.DmRmc100C, DmRmc100CAdapterSettings>
#else
	public sealed class DmRmc100CAdapter : AbstractDmRmc100CBaseAdapter<DmRmc100CAdapterSettings>
#endif
	{
#if SIMPLSHARP
		public override Crestron.SimplSharpPro.DM.Endpoints.Receivers.DmRmc100C InstantiateReceiver(byte ipid, CrestronControlSystem controlSystem)
		{

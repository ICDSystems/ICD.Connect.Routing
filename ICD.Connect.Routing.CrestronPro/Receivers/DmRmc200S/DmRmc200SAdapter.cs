...
{
#if SIMPLSHARP
	public sealed class DmRmc200SAdapter :
		AbstractEndpointReceiverBaseAdapter<Crestron.SimplSharpPro.DM.Endpoints.Receivers.DmRmc200S, DmRmc200SAdapterSettings>
#else
	public sealed class DmRmc200SAdapter : AbstractEndpointReceiverBaseAdapter<DmRmc200SAdapterSettings>
#endif
	{
		/// <summary>
		...
		public override Crestron.SimplSharpPro.DM.Endpoints.Receivers.DmRmc200S InstantiateReceiver(byte ipid,
		                                                                                            CrestronControlSystem
			                                                                                            controlSystem)
		{
			return new Crestron.SimplSharpPro.DM.Endpoints.Receivers.DmRmc200S(ipid, controlSystem);
		}

		public override Crestron.SimplSharpPro.DM.Endpoints.Receivers.DmRmc200S InstantiateReceiver(byte ipid, DMOutput output)
		{
			return new Crestron.SimplSharpPro.DM.Endpoints.Receivers.DmRmc200S(ipid, output);
		}

		public override Crestron.SimplSharpPro.DM.Endpoints.Receivers.DmRmc200S InstantiateReceiver(DMOutput output)
		{
			return new Crestron.SimplSharpPro.DM.Endpoints.Receivers.DmRmc200S(output);
		}

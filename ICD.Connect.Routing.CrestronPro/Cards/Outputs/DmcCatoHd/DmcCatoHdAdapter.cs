...
namespace ICD.Connect.Routing.CrestronPro.Cards.Outputs.DmcCatoHd
{
	...
	public sealed class DmcCatoHdAdapter : AbstractOutputCardAdapter<DmcCatoHdSingle, DmcCatoHdAdapterSettings>
	{
		...
		/// Constructor.
		/// </summary>
		public DmcCatoHdAdapter()
		{
			Controls.Add(new DmcCatoHdAdapterRoutingControl(this, 0));
		}
...
#else
	public sealed class DmcCatoHdAdapter : AbstractDmc4kCoHdBaseAdapter<DmcCatoHdAdapterSettings>
	{
	    protected override bool GetIsOnlineStatus()
	    {
	        return false;

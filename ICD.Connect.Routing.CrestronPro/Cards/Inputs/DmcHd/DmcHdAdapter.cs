...
namespace ICD.Connect.Routing.CrestronPro.Cards.Inputs.DmcHd
{
		...
		AbstractInputCardAdapter<Crestron.SimplSharpPro.DM.Cards.DmcHd, DmcHdAdapterSettings>
	{
		...
		protected override void AddControls(DmcHdAdapterSettings settings, IDeviceFactory factory, Action<IDeviceControl> addControl)
		{
			base.AddControls(settings, factory, addControl);

			addControl(new DmcHdAdapterRoutingControl(this, 0));
		}
